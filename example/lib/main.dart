...
class HomeScene extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          _buildItem(context, 'Example-1', ExcelModel(
            x: 16,
            y: 16,
            showSn: true,
          ...
          _buildItem(context, 'Example-2', ExcelModel(
            x: 18,
            y: 16,
            showSn: false,
            backgroundColor: Colors.white,
          ...
          _buildItem(context, 'Example-3', ExcelModel(
            x: 18,
            y: 16,
            showSn: true,
            backgroundColor: Colors.white,
          ...
          _buildItem(context, 'Example-4', ExcelModel(
            x: 5,
            y: 5,
            showSn: true,
            backgroundColor: Colors.white,
            ...
            ExcelItemModel(
              position: ExcelPosition(0, 0),
              value: ExcelExampleModel(value: '10'),
              builder: () => const Icon(Icons.ac_unit, size: 10, color: Colors.purple,),
              isReadOnly: true,
            ),
          ]),
        ],
  ...
  Widget _buildItem(BuildContext context, String title, ExcelModel excel, List<ExcelItemModel<ExcelExampleModel>> items) {
    return ListTile(
      title: Text(title),
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (_) => ExampleScene(
          title: title,
          excel: excel,
          items: items,
        )));
